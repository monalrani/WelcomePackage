define(['angular', './sample-module', ], function (angular, controllers) {
    ...
    controllers.controller('PXChartCtrl', ['$scope', '$rootScope', function ($scope, $rootScope) {
    	
    	
       function histogramStackedChart(){
        	var margin = {
                    top: 10,
                    right: 30,
                    bottom: 30,
            ...
            // Get the data
            d3.csv("http://bl.ocks.org/sbrudz/raw/8ac4f4102f787d0fcea5/8cf9e174065c13fa1a484110e0548e1c0b32703e/Rat_Sightings.csv", function(error, data) {
