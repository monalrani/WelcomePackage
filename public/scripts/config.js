...
require.config({
    ...
    paths: {
        ...
        d3Transform: '../bower_components/custom/d3-transform',
        extrarray: '../bower_components/custom/extarray',
        misc: '../bower_components/custom/misc',
        microObserver: '../bower_components/custom/micro-observer',
        microPlugin: '../bower_components/custom/microplugin',
        bubbleChart: '../bower_components/custom/bubble-chart',
        centralClick: '../bower_components/custom/central-click',
        lines: '../bower_components/custom/lines',
